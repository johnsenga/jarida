...
public class CurlView extends GLSurfaceView implements View.OnTouchListener,
	...
	private long mAnimationDurationTime = 700;//300;
	...
	// One page is the default.SHOW_TWO_PAGES
	...
	public boolean onTouch(View view, MotionEvent me) {
		...
		//Toast.makeText(getContext(), "You touched page "+mCurrentIndex, Toast.LENGTH_SHORT).show();
	...
	private void updatePage(CurlPage page, int index) {
		...
		//Log.e("You touched page ", String.valueOf(index) );
