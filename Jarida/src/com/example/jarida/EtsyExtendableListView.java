 ...
 */
public abstract class EtsyExtendableListView extends AbsListView {
    ...
    public EtsyExtendableListView(final Context context, final AttributeSet attrs, final int defStyle) {
    ...
    public void setAdapter(final ListAdapter adapter) {
        ...
        if (mHeaderViewInfos.size() > 0 || mFooterViewInfos.size() > 0) {
            mAdapter = new EtsyHeaderViewListAdapter(mHeaderViewInfos, mFooterViewInfos, adapter);
        }
        else {
            mAdapter = adapter;
        }
    ...
    public void addHeaderView(View v, Object data, boolean isSelectable) {
        ...
        if (mAdapter != null && !(mAdapter instanceof EtsyHeaderViewListAdapter)) {
    ...
    public boolean removeHeaderView(View v) {
        if (mHeaderViewInfos.size() > 0) {
            ...
            if (mAdapter != null && ((EtsyHeaderViewListAdapter) mAdapter).removeHeader(v)) {
                if (mObserver != null) {
                    mObserver.onChanged();
                }
                result = true;
    ...
    public boolean removeFooterView(View v) {
        if (mFooterViewInfos.size() > 0) {
            boolean result = false;
            if (mAdapter != null && ((EtsyHeaderViewListAdapter) mAdapter).removeFooter(v)) {
                if (mObserver != null) {
                    mObserver.onChanged();
                }
                result = true;
...
//            case TOUCH_MODE_OVERSCROLL:
    ...
    class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (EtsyExtendableListView.this.getAdapter().hasStableIds() && mInstanceState != null
                    && mOldItemCount == 0 && mItemCount > 0) {
                EtsyExtendableListView.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            }
            else {
                rememberSyncState();
        ...
        public void onInvalidated() {
            ...
            if (EtsyExtendableListView.this.getAdapter().hasStableIds()) {
                // Remember the current state for the case where our hosting activity is being
                // stopped and later restarted
                mInstanceState = EtsyExtendableListView.this.onSaveInstanceState();
            }
    ...
    public static class ListSavedState extends EtsyClassLoaderSavedState {
