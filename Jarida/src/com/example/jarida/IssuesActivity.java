...
public class IssuesActivity extends SherlockFragmentActivity implements MenuItems{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String Magazine = myIntent.getExtras().getString("Magazine");
	        getPrefs();
	        bindViews();
	        initState();
        ...
        mFragmentTabPager.addTab(ab.newTab().setText(Magazine+" Magazine"), IssuesFragment.class, b);
/*
        b = new Bundle();
