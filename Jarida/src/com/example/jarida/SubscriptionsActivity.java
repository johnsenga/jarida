...
public class SubscriptionsActivity extends SherlockFragmentActivity implements MenuItems {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFragmentTabPager.addTab(ab.newTab().setText("All Categories"), SubscriptionsFragment.class, b);
/*
        b = new Bundle();
