 ...
 * on 2013-12-15 at 08:23:02 UTC 
 * Modify at your own risk.
 */

package com.example.jarida.placeendpoint;
...
public class Placeendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetPlace extends PlaceendpointRequest<com.example.jarida.placeendpoint.model.Place> {
    ...
    protected GetPlace(java.lang.Long id) {
      super(Placeendpoint.this, "GET", REST_PATH, null, com.example.jarida.placeendpoint.model.Place.class);
   ...
   * operation.
   *
   * @param content the {@link com.example.jarida.placeendpoint.model.Place}
   * @return the request
   */
  public InsertPlace insertPlace(com.example.jarida.placeendpoint.model.Place content) throws java.io.IOException {
    InsertPlace result = new InsertPlace(content);
    initialize(result);
    return result;
  }

  public class InsertPlace extends PlaceendpointRequest<com.example.jarida.placeendpoint.model.Place> {
     ...
     * @since 1.13
     */
    protected InsertPlace(com.example.jarida.placeendpoint.model.Place content) {
      super(Placeendpoint.this, "POST", REST_PATH, content, com.example.jarida.placeendpoint.model.Place.class);
    }
  ...
  public class ListPlace extends PlaceendpointRequest<com.example.jarida.placeendpoint.model.CollectionResponsePlace> {
     ...
     */
    protected ListPlace() {
      super(Placeendpoint.this, "GET", REST_PATH, null, com.example.jarida.placeendpoint.model.CollectionResponsePlace.class);
    }
   ...
   * @return the request
   */
  public UpdatePlace updatePlace(com.example.jarida.placeendpoint.model.Place content) throws java.io.IOException {
    UpdatePlace result = new UpdatePlace(content);
    initialize(result);
    return result;
  }

  public class UpdatePlace extends PlaceendpointRequest<com.example.jarida.placeendpoint.model.Place> {
     ...
     * @since 1.13
     */
    protected UpdatePlace(com.example.jarida.placeendpoint.model.Place content) {
      super(Placeendpoint.this, "PUT", REST_PATH, content, com.example.jarida.placeendpoint.model.Place.class);
    }
